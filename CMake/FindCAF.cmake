...
#
#  CAF_ROOT_DIR  Set this environment variable either to an installation prefix or to
...
set( CAF_ROOT_DIR "$ENV{CAF_ROOT_DIR}" )
...
foreach (comp ${CAF_FIND_COMPONENTS})
  ...
  message("Searching for component ${UPPERCOMP}")
  ...
  if (NOT "${CAF_INCLUDE_DIR_${UPPERCOMP}}"
    ...
    if (NOT ${comp} STREQUAL "probe_event" AND NOT ${comp} STREQUAL "test")
      if (CAF_ROOT_DIR)
        set(library_hints "${CAF_ROOT_DIR}/lib/Debug")
      endif ()
      find_library(CAF_LIBRARY_${UPPERCOMP}
                   NAMES
                     "caf_${comp}"
                     "caf_${comp}_static" # Handle static libraries as well
                   HINTS
                     ${library_hints}
                     /usr/lib
                     /usr/local/lib
